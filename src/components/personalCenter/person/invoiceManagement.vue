...
<template>
  <div>
    ...
    <div class="addClass">
      <el-button size="small" type="primary" @click="dialogFormVisible = true">新增发票</el-button>
      <span style="margin-left:30px;">您已创建5个发票，最多可创建20个。</span>
    </div>
    <div class="addressClass" v-for="(item,index) in list" :key="index">
      ...
      <div>
        <el-button size="small" type="primary"  @click="dialogFormVisible = true">编辑</el-button>
        <!-- <div v-else>
